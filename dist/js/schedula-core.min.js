(() => {
  ...
  var DefaultPopupPlugin = class {
    ...
    refreshItem(item) {
      var _a, _b;
      console.log("[DefaultPopupPlugin] refreshItem called", { currentItemId: (_a = this._currentItem) == null ? void 0 : _a.Id, itemId: item.Id, popupDisplay: (_b = document.getElementById("scheduler-default-popup")) == null ? void 0 : _b.style.display });
      if (this._currentItem && this._currentItem.Id === item.Id) {
        const popup = document.getElementById("scheduler-default-popup");
        if (popup && popup.style.display !== "none") {
          console.log("[DefaultPopupPlugin] Updating popup with new data");
          this._populatePopup(popup, item);
        } else {
          console.log("[DefaultPopupPlugin] Popup hidden or not found");
        }
      } else {
        console.log("[DefaultPopupPlugin] Item mismatch");
      }
    }
    hide() {
      const popup = document.getElementById("scheduler-default-popup");
                ...
                <div class="popup-container">
                    ...
                    <div class="popup-content">
                        <div class="tab">
                            ...
                            <button class="tab-btn" data-tab="json">Data</button>
                        </div>
    ...
    _populatePopup(popup, item) {
      ...
      popup.querySelector("#default-popup-field-json").value = item.data != null ? JSON.stringify(item.data, null, 2) : "(no data)";
  ...
  var SchedulaCore = class {
    ...
    processData() {
      ...
      this.settings.date.setSeconds(0, 0);
