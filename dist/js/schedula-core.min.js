(() => {
  ...
  var DefaultPopupPlugin = class {
    ...
    show(item, event, scheduler) {
      const popup = this._getOrCreateElement();
      const fmt = (mins) => mins != null ? new Date(mins * 6e4).toLocaleString() : "";
      popup.innerHTML = `
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; border-bottom:1px solid #e2e8f0; padding-bottom:10px;">
                <h3 style="margin:0; font-size:16px; color:#1e293b;">Task Info</h3>
                <button onclick="this.closest('div').parentElement.style.display='none'" style="border:none; background:none; cursor:pointer; font-size:18px;">&times;</button>
            </div>
            <div style="font-size:14px; color:#475569; line-height:1.6;">
                ...
                <p><strong>From:</strong> ${fmt(item.From)}</p>
                <p><strong>To:</strong> ${fmt(item.To)}</p>
                ${item.Completion != null ? `<p><strong>Completion:</strong> ${item.Completion}%</p>` : ""}
            </div>
        `;
    ...
    _getOrCreateElement() {
      if (!this._element) {
        ...
        this._element.className = "schedula-default-popup";
    ...
    onItemClick(event, element) {
      if (element && element.item) {
        this.show(element.item, event, this._core);
      }
    }
  };
