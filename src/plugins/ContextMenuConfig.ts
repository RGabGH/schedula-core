 ...
 *   'task-start'    — sets StartedAt, adds CSS class 'active' (task context only)
 *   'task-pause'    — clears 'active' class, sets PausedAt    (task context only)
 *   'task-complete' — sets Completed/CompletedAt, adds class 'completed' (task context only)
...
export const defaultTaskMenuItems: IMenuItemDef[] = [
    ...
    { id: 'task-start',    label: 'Start' },
    { id: 'task-pause',    label: 'Pause' },
    { id: 'task-complete', label: 'Complete' },
