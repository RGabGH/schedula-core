...
class SchedulerItem2 {
    ...
    set Resource(value) {
        ...
        if (value >= 0) {
            ...
            let x = parseFloat((_a = this._element) === null || _a === void 0 ? void 0 : _a.getAttribute('x'));
...
class Scheduler {
    ...
    handleMouseMove(event) {
        ...
        let offsets = (_b = (_a = document.getElementById('scheduler')) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()) !== null && _b !== void 0 ? _b : {
            x: 0,
            y: 0
        };
        ;
    ...
    drawItem(item, ri) {
        ...
        if (!item.Removed == true) {
            ...
            let nopadding = (_b = (_a = item.Classes) === null || _a === void 0 ? void 0 : _a.includes('nopadding')) !== null && _b !== void 0 ? _b : false;
            let arrow = (this.settings.gStyle === 'arrow' || ((_d = (_c = item.Classes) === null || _c === void 0 ? void 0 : _c.includes('arrow')) !== null && _d !== void 0 ? _d : false));
            let gantt = false;
            let mask = arrow || gantt;
            let roundrect = (this.settings.gStyle === 'round-rect' || ((_f = (_e = item.Classes) === null || _e === void 0 ? void 0 : _e.includes('round-rect')) !== null && _f !== void 0 ? _f : false));
            let circle = (this.settings.gStyle === 'circle' || ((_h = (_g = item.Classes) === null || _g === void 0 ? void 0 : _g.includes('circle')) !== null && _h !== void 0 ? _h : false));
            ...
            ItemSVG.setAttribute('data-ref', (_o = item.Reference) !== null && _o !== void 0 ? _o : '');
            ...
            (_p = item.Classes) === null || _p === void 0 ? void 0 : _p.split(' ').forEach((c) => {
                if (c)
            ...
            const cliprect = itemrect.cloneNode(false);
            ...
            let imgspace = this.settings.resourceHeight * 0.1;
            let imgX = imgspace;
            (_q = item.Icons) === null || _q === void 0 ? void 0 : _q.forEach((icon, ii) => {
                if (icon.Name) {
                    const use = document.createElementNS('http://www.w3.org/2000/svg', 'use');
                    use.setAttribute('href', '#' + icon.Name);
                    use === null || use === void 0 ? void 0 : use.setAttribute('x', imgX.toString());
                    use === null || use === void 0 ? void 0 : use.setAttribute('y', '50%');
                    use === null || use === void 0 ? void 0 : use.setAttribute('height', imgdim.toString());
                    use === null || use === void 0 ? void 0 : use.setAttribute('width', imgdim.toString());
    ...
    processItemAction(element, data) {
    ...
    processRowShift(element, data) {
        var _a, _b;
        if (this.calendar != null) {
            let y = parseFloat((_a = element.getAttribute('y')) !== null && _a !== void 0 ? _a : '0');
            let dy = parseFloat((_b = element.getAttribute('data-y')) !== null && _b !== void 0 ? _b : '0');
            let item = this.getItemData(data.Id);
            if (item) {
                console.log(item);
    ...
    checkInterference(x, y, w, e) {
        ...
        if (this.settings.checkInterferences) {
            ...
            elements.forEach((element, i) => {
                var _a, _b, _c;
                if (element != e) {
                    let cx1 = parseFloat((_a = element.getAttribute('x')) !== null && _a !== void 0 ? _a : '0');
                    let cy = parseFloat((_b = element.getAttribute('y')) !== null && _b !== void 0 ? _b : '0');
                    let cw = parseFloat((_c = element.getAttribute('width')) !== null && _c !== void 0 ? _c : '0');
                    let cx2 = cx1 + cw;
                    if (cy == y) {
    ...
    getItemData(id) {
        var _a;
        let res = null;
        (_a = this.data.Resources) === null || _a === void 0 ? void 0 : _a.forEach((resource) => {
            var _a;
            (_a = resource.Items) === null || _a === void 0 ? void 0 : _a.forEach((item) => {
                if (item.Id == id)
                    res = item;
    ...
    updateData(element) {
        ...
        (_a = this.data.Resources) === null || _a === void 0 ? void 0 : _a.forEach((resource, ri) => {
            ...
            (_a = resource.Items) === null || _a === void 0 ? void 0 : _a.forEach((item) => {
                ...
                if (item.Id == id) {
                    let x = parseFloat((_a = element.getAttribute('x')) !== null && _a !== void 0 ? _a : '0');
                    let w = parseFloat((_b = element.getAttribute('width')) !== null && _b !== void 0 ? _b : '0');
                    ...
                    item.To = to;
                    if (ri != resourceIndex) {
                        (_c = this.data.Resources[ri].Items) === null || _c === void 0 ? void 0 : _c.splice((_d = this.data.Resources[ri].Items) === null || _d === void 0 ? void 0 : _d.indexOf(item), 1);
                        if (!this.data.Resources[resourceIndex].Items)
                            this.data.Resources[resourceIndex].Items = [];
                        (_e = this.data.Resources[resourceIndex].Items) === null || _e === void 0 ? void 0 : _e.push(item);
                    }
                }
            });
        });
    ...
    moveAnimatedTo(element, x, y) {
        var _a, _b;
        if (!element)
            return;
        let cx = parseFloat((_a = element.getAttribute('x')) !== null && _a !== void 0 ? _a : '0');
        let cy = parseFloat((_b = element.getAttribute('y')) !== null && _b !== void 0 ? _b : '0');
        let animatex = document.createElementNS('http://www.w3.org/2000/svg', 'animate');
        animatex.setAttribute('attributeName', 'x');
        animatex.setAttribute('values', cx.toString() + ';' + x.toString());
    ...
    setAnimatedWidth(element, width) {
        var _a;
        if (!element)
            return;
        let w = parseFloat((_a = element.getAttribute('width')) !== null && _a !== void 0 ? _a : '0');
        let animatew = document.createElementNS('http://www.w3.org/2000/svg', 'animate');
        animatew.setAttribute('attributeName', 'width');
        animatew.setAttribute('values', w.toString() + ';' + width.toString());
        animatew.setAttribute('dur', '0.15s');
    ...
    initPopup(popup) {
        ...
        popup.querySelectorAll('.tablinks').forEach((element) => {
            element.addEventListener('click', (event) => { var _a; return this.showTab(event, (_a = element.getAttribute('data-tab')) !== null && _a !== void 0 ? _a : ''); });
        });
    }
    showTab(evt, tabid) {
    ...
    splitterBarMouseUp(event) {
        this.action = '';
    }
    splitterBarMouseMove() {
    }
    splitterBarDblClick() {
    }
    setSplitBarPos(pos) {
