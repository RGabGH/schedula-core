...
enum SchedulerView{ 
 ...
 class Scheduler {
        ...
        if (parent)
        {
            ...
            if (this.data.Resources){
                ...
                this.data.Resources.forEach((resource,ri)=>{
                    ...
                    line.setAttribute('class', "bg-hl "+this.settings.theme);
                    parent?.append(line);
                });
                ...
                for (let c = 0; c < this.settings.timeUnitsCount; c++) {
                    ...
                    if (dt) {
                       ...
                       // ratio=1;
                        ...
                        line.setAttribute('class', "bg-vl "+this.settings.theme);
                        parent?.append(line);
                        ...
                        for (let rr = 0; rr < rcount; rr++) {
                            ...
                            rect.setAttribute('class','box-element '+this.settings.theme);
    ...
    private drawResBg() {
        ...
        rect.setAttribute('class','sb-rbg '+this.settings.theme);
        ...
        svg.setAttribute('class','sb-hbg '+this.settings.theme);
        ...
        elem.setAttribute('class','sb-hbg '+this.settings.theme);


        const text=document.createElementNS('http://www.w3.org/2000/svg', "text");
        text.setAttribute('x',(x+2).toString());
        text.setAttribute('y',(y-2).toString());
        text.setAttribute('class','resource-header-text '+this.settings.theme);
    ...
    private drawResources() {
        ...
        if (this.data.Resources)
        {
            ...
            this.data.Resources.forEach((resource, ri)=>{
                ...
                if (this.settings.theme) res.classList.add(this.settings.theme);
                if (resource.Classes) {
                ...
                if (this.settings.theme) restext.classList.add(this.settings.theme);
        ...
        if (this.settings.viewInfoElements)
        {
            ...
            if (dt) {
                ...
                for (let i = 0; i < this.settings.timeUnitsCount; i++) {
                    ...
                    if (this.settings.theme) elem.classList.add(this.settings.theme);
    ...
    private drawItem(item:any, ri:number){    
            if (!item.Removed==true) 
            {
                ...
                if (this.settings.theme) itemrect.classList.add(this.settings.theme);
                ...
                if (this.settings.itemsText) {  
                    ...
                    if (this.settings.theme) itemtext.classList.add(this.settings.theme);
                    ...
                    if (this.settings.theme) itemtext2.classList.add(this.settings.theme);
                            ...
                            this.data.Resources?.forEach((resource2,resindex2)=>{
                                resource2.Items?.forEach((item2,index2)=>{
                                    ...
                                    if ((samelink || idlink) && singletime && notitself) {
                                        ...
                                        linkline.setAttribute('class','link link-wire '+this.settings.theme);
        ...
        if (this.settings.viewEvents == true) {
            ...
            if (this.data.Events)
            {
                ...
                this.data.Events.forEach((event,ei)=>{
                    ...
                    svgevent.setAttribute('class',"svg-event draggable-x "+this.settings.theme);
                    ...
                    ev.setAttribute('class','event-header '+this.settings.theme+ ' '+event.Classes);
                    ...
                    if (this.settings.viewEventExtended == true) {
                        ...
                        extevent.setAttribute('class','event-extension '+this.settings.theme+ ' '+event.Classes);
    ...
    private drawHeader() {
        ...
        if (parent){
            ...
            header.setAttribute('class', "header-bg "+this.settings.theme);
        ...
        if (dt && parent) {
            ...
            for (let i = 0; i < this.settings.timeUnitsCount; i++) {
                ...
                if (month != lastmonth) {
                    ...
                    if (this.settings.theme) monthBox.classList.add(this.settings.theme);
                    ...
                    if (this.settings.theme) text.classList.add(this.settings.theme);
                    text.innerHTML=t;
        ...
        if (dt && parent) {
            ...
            for (let i = 0; i < this.settings.timeUnitsCount; i++) {
                ...
                if (this.settings.viewWeeks && (hilight||i==0) && this.settings.timeUnitVal==1440) {
                    ...
                    let txt='WEEK '+this.getWeekOfYear(cdate);
    ...
    private drawTimeUnits(){
        ...
        if (dt && parent) {
            ...
            for (let i = 0; i < this.settings.timeUnitsCount; i++) {
                ...
                if (this.settings.theme) dummy.classList.add(this.settings.theme);       
